 ...
 *
 * Source of truth: packages/shared/src/types/index.ts (Song parts /
 * arrangements / User) and apps/api/src/models/{User,Playlist}.ts.
...
/** Firestore `users` doc shape (apps/api/src/models/User.ts). */
...
/** Firestore `playlists` doc shape (apps/api/src/models/Playlist.ts). */
