...
export default function NewSongPage() {
    ...
    const handleImportPreview = async () => {
        ...
        try {
            const result = await api.post<ImportedSong>('/api/import/preview', { url: importUrl });
                                ...
                                <div className={styles.preview}>
                                    ...
                                    <div className={styles.previewLyrics}>
                                        {importedSong.parts.slice(0, 2).map((part, i) => (
                                            <div key={i} className={styles.previewPart}>
                                                <strong>{part.type} {part.index}</strong>
                                    ...
                                    <QuickAddForm
                                        initialData={{
                                            ...
                                            content: importedSong.parts.map(p => {
                                                const partName = p.type.charAt(0).toUpperCase() + p.type.slice(1);
